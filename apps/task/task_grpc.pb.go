...
const (
	Service_CreateTask_FullMethodName   = "/tqtcloud.task.Service/CreateTask"
	Service_CopyTask_FullMethodName     = "/tqtcloud.task.Service/CopyTask"
	Service_QueryTask_FullMethodName    = "/tqtcloud.task.Service/QueryTask"
	Service_DescribeTask_FullMethodName = "/tqtcloud.task.Service/DescribeTask"
	Service_UpdateTask_FullMethodName   = "/tqtcloud.task.Service/UpdateTask"
	Service_DeleteTask_FullMethodName   = "/tqtcloud.task.Service/DeleteTask"
	Service_SshExec_FullMethodName      = "/tqtcloud.task.Service/SshExec"
)
...
type ServiceClient interface {
	...
	CopyTask(ctx context.Context, in *CreateTaskRequest, opts ...grpc.CallOption) (*Task, error)
	...
	SshExec(ctx context.Context, in *ExecRequest, opts ...grpc.CallOption) (*ExecResp, error)
}
...
func (c *serviceClient) CopyTask(ctx context.Context, in *CreateTaskRequest, opts ...grpc.CallOption) (*Task, error) {
	out := new(Task)
	err := c.cc.Invoke(ctx, Service_CopyTask_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceClient) UpdateTask(ctx context.Context, in *UpdateTaskRequest, opts ...grpc.CallOption) (*Task, error) {
	out := new(Task)
...
func (c *serviceClient) DeleteTask(ctx context.Context, in *DeleteTaskRequest, opts ...grpc.CallOption) (*Task, error) {
	out := new(Task)
...
func (c *serviceClient) SshExec(ctx context.Context, in *ExecRequest, opts ...grpc.CallOption) (*ExecResp, error) {
	out := new(ExecResp)
	err := c.cc.Invoke(ctx, Service_SshExec_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ServiceServer interface {
	...
	CopyTask(context.Context, *CreateTaskRequest) (*Task, error)
	...
	SshExec(context.Context, *ExecRequest) (*ExecResp, error)
...
func (UnimplementedServiceServer) CopyTask(context.Context, *CreateTaskRequest) (*Task, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CopyTask not implemented")
}
...
func (UnimplementedServiceServer) UpdateTask(context.Context, *UpdateTaskRequest) (*Task, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateTask not implemented")
}
func (UnimplementedServiceServer) DeleteTask(context.Context, *DeleteTaskRequest) (*Task, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteTask not implemented")
}
func (UnimplementedServiceServer) SshExec(context.Context, *ExecRequest) (*ExecResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SshExec not implemented")
}
...
func _Service_CopyTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateTaskRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ServiceServer).CopyTask(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Service_CopyTask_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServiceServer).CopyTask(ctx, req.(*CreateTaskRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Service_SshExec_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ExecRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ServiceServer).SshExec(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Service_SshExec_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServiceServer).SshExec(ctx, req.(*ExecRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Service_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "tqtcloud.task.Service",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CopyTask",
			Handler:    _Service_CopyTask_Handler,
		},
		{
		...
		{
			MethodName: "SshExec",
			Handler:    _Service_SshExec_Handler,
		},
	},
