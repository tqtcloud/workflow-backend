PROJECT_NAME := "workflow-backend"
MAIN_FILE_PAHT := "main.go"
PKG := "github.com/tqtcloud/workflow-backend"
IMAGE_PREFIX := "github.com/tqtcloud/workflow-backend"
...
docker:
	@docker build -t ${IMAGE_PREFIX}:${BUILD_COMMIT} .
	@docker tag ${IMAGE_PREFIX}:${BUILD_COMMIT} ${IMAGE_PREFIX}:latest
